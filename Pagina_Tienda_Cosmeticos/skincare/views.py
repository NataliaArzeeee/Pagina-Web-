...
# Importa la función 'random' para seleccionar un consejo al azar

def consejos(request):
    # Lista de consejos de cuidado facial
    consejos_cuidado_facial = [
    "Mantén tu piel limpia lavándola suavemente dos veces al día con un limpiador facial adecuado para tu tipo de piel.",
    "Aplica una crema hidratante de calidad para mantener tu piel hidratada y saludable.",
    "No olvides aplicar protector solar todos los días para proteger tu piel de los daños causados por el sol.",
    "Exfolia tu piel una o dos veces a la semana para eliminar las células muertas y mejorar la textura de la piel.",
    "Usa una mascarilla facial una vez por semana para tratar problemas específicos de la piel, como la hidratación, el acné o la luminosidad.",
    "Bebe suficiente agua para mantener tu piel bien hidratada desde adentro.",
    "Evita tocar tu rostro con las manos sucias para prevenir la transferencia de gérmenes y bacterias.",
    "Limpia tus brochas y herramientas de maquillaje regularmente para evitar la acumulación de bacterias.",
    "Incorpora antioxidantes en tu rutina, como la vitamina C, para proteger tu piel contra los radicales libres.",
    "Descansa lo suficiente, ya que el sueño es importante para la regeneración celular y la salud de la piel."]


    # Selecciona un consejo al azar
    consejo = random.choice(consejos_cuidado_facial)

    return render(request, 'skincare/consejos.html', {'consejo': consejo})
